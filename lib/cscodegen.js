...
(function() {
  ...
  (function(exports) {
    ...
    return exports.generate = generate = function(ast, options) {
      var a, arg, argList, args, assignee, block, body, ctor, expr, fn, i, indexingExpr, left, memberName, needsParens, op, p, paramList, parameters, parent, parentClassName, prec, right, s, src, _ref, _ref1;
      if (options == null) {
        options = {};
      }
      needsParens = false;
