...
(function() {
  ...
  (function(exports) {
    ...
    return exports.generate = generate = function(ast, options) {
      var a, absNum, arg, argList, args, assignee, block, body, ctor, expr, fn, i, indexingExpr, left, needsParens, op, p, paramList, parameters, parent, parentClassName, prec, right, s, sep, src, usedAsExpression, _ref, _ref1;
      if (options == null) {
        options = {};
      }
      needsParens = false;
