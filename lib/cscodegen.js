...
(function() {
  ...
  (function(exports) {
    ...
    levels = [['SeqOp'], ['Conditional', 'ForIn', 'ForOf', 'While'], ['AssignOp', 'CompoundAssignOp', 'ExistsAssignOp'], ['LogicalOrOp'], ['LogicalAndOp'], ['BitOrOp'], ['BitXorOp'], ['BitAndOp'], ['ExistsOp'], ['EQOp', 'NEQOp'], ['LTOp', 'LTEOp', 'GTOp', 'GTEOp', 'InOp', 'OfOp', 'InstanceofOp'], ['LeftShiftOp', 'SignedRightShiftOp', 'UnsignedRightShiftOp'], ['AddOp', 'SubtractOp'], ['MultiplyOp', 'DivideOp', 'RemOp'], ['FunctionApplication', 'SoakedFunctionApplication'], ['UnaryPlusOp', 'UnaryNegateOp', 'LogicalNotOp', 'BitNotOp', 'DoOp', 'TypeofOp', 'PreIncrementOp', 'PreDecrementOp', 'DeleteOp'], ['UnaryExistsOp', 'ShallowCopyArray', 'PostIncrementOp', 'PostDecrementOp', 'Spread'], ['NewOp'], ['MemberAccessOp', 'SoakedMemberAccessOp', 'DynamicMemberAccessOp', 'SoakedDynamicMemberAccessOp', 'ProtoMemberAccessOp', 'DynamicProtoMemberAccessOp', 'SoakedProtoMemberAccessOp', 'SoakedDynamicProtoMemberAccessOp']];
    precedence = {};
    (function() {
    ...
    return exports.generate = generate = function(ast, options) {
      var a, argList, args, assignee, block, body, ctor, expr, fn, indexingExpr, left, memberName, needsParens, op, p, paramList, parameters, prec, right, s, src, _ref;
      if (options == null) {
        options = {};
      }
      needsParens = false;
      ...
      src = (function() {
        ...
        switch (ast.className) {
          ...
          case 'ExistsOp':
            ...
            options.precedence = prec;
            left = generate(ast.left, options);
            if ((_ref1 = ast.left.className) === 'Function' || _ref1 === 'BoundFunction') {
              left = "(" + left + ")";
            }
            right = generate(ast.right, options);
          ...
          case 'Spread':
            ...
            options.precedence = prec;
            expr = generate(ast.expr, options);
            if ((_ref2 = ast.expr.className) === 'Function' || _ref2 === 'BoundFunction') {
              expr = "(" + expr + ")";
            }
            return "" + expr + op;
          case 'PreIncrementOp':
          ...
          case 'NewOp':
            ...
            if (ast["arguments"].length > 0 && ((_ref3 = ast.ctor.className) === 'Function' || _ref3 === 'BoundFunction')) {
              ctor = "(" + ctor + ")";
            }
          ...
          case 'SoakedFunctionApplication':
            ...
            if ((_ref4 = ast["function"].className) === 'Function' || _ref4 === 'BoundFunction') {
              fn = "(" + fn + ")";
            }
            args = (function() {
